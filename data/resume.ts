export const resumeData = {
  ...
  projects: [
    ...
    },
    {
      ...
      image: "/thumbnail/cortex-bench-ai.png",
      tags: ["Python", "FastAPI", "Streamlit", "Ollama", "spaCy", "Presidio"],
      liveUrl: "https://example.com",
      codeUrl: "https://github.com/Devnil434/cortex-bench",
    ...
    },
    {
      id: "project-5",
      title: "LawMind",
      shortDescription: "An AI-powered legal assistant that simplifies complex legal documents and provides instant plain-language legal guidance.",
      fullDescription:
        "LawMind is an intelligent legal assistant designed to bridge the gap between complex legal language and everyday users. It leverages large language models to analyze legal documents, summarize contracts, identify risk clauses, and provide jurisdiction-aware legal guidance — democratizing access to legal information.",
      problem: "Legal documents are notoriously complex and expensive to interpret, leaving most people unable to understand contracts, rights, or legal risks without hiring a lawyer.",
      solution: "Built an AI-powered platform that ingests legal documents, extracts key clauses, flags risk areas, and provides plain-language summaries with jurisdiction-aware legal guidance.",
      features: [
        ...
        "Contract Q&A via LLM",
      ],
      metrics: [
        { label: "Accuracy", val: 93 },
        { label: "User Clarity", val: 97 },
        { label: "Speed", val: 98 },
      ],
      image: "/thumbnail/LawMind.png",
      tags: ["Python", "LangChain", "FastAPI", "React", "LLM", "NLP"],
      liveUrl: "https://example.com",
      codeUrl: "https://github.com/Devnil434/LawMind",
      color: "#6C63FF",
    },
  ],
  experience: [
