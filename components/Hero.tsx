...
export function Hero() {
  const { name, role, tagline, bio, email } = resumeData.personalInfo;
      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.h1
              {...fadeUp(0.1)}
              className="text-5xl md:text-6xl xl:text-7xl font-black leading-[1.02] tracking-tight"
            >
              I&apos;m{" "}
            ...
            <motion.p
              {...fadeUp(0.3)}
              className="text-[var(--fg-muted)] text-lg leading-relaxed max-w-md"
            >
              {bio}
            </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-col items-center justify-center gap-4 order-1 lg:order-2"
          ...
          >
            <AvatarEntity
              size={420}
              clickBurst
              className="max-w-[280px] sm:max-w-[340px] md:max-w-[420px] w-full"
            />

            {/* Available badge below avatar */}
            <motion.div
              className="glass flex items-center gap-2 px-4 py-2 rounded-full text-xs font-mono"
            ...
            >
              <span
                className="w-2 h-2 rounded-full bg-emerald-400 breathe"
